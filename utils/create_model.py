import os
import torch
os.chdir("/project/segmentation/smcho1201/segmentation_project")
...
#         model.weights(
    ...
    if model_name == "CASCADE":
        from models.sotor_medical_seg_models.CASCADE.lib.networks import PVT_CASCADE
        model = PVT_CASCADE()
        return model

    if model_name == "TResUNet":
        from models.sotor_medical_seg_models.TransResUNet.model import TResUnet
        model = TResUnet()
        return model    
