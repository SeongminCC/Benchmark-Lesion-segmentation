...
#     pred = pred.cpu()
    ...
    elif isinstance(pred, tuple):  # tensor 가 tuple 에 감싸져오는 경우가 있음
...
def plot_test_image(models :list, DEVICE, test_images, test_labels, data_name, number):#, save_dir, epochs):
    size = (224,224)
...
def plot_test_image_1(models :list, DEVICE, test_images, test_labels, data_name, number):#, save_dir, epochs):
    size = (256, 256)
